...
이제 SQL을 작성하기 전에 기본 규칙을 먼저 이해합니다.
...
### 6.1. DDL (Data Definition Language, 데이터 정의어)
...
### 6.2. DML (Data Manipulation Language, 데이터 조작어)
...
### 6.3. DCL (Data Control Language, 데이터 제어어)
...
### 6.4. TCL (Transaction Control Language, 트랜잭션 제어어)
