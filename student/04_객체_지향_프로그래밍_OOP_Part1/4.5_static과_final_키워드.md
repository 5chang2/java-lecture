...
public class Main {
    public static void main(String[] args) {
        System.out.println("초기 카운트: " + Counter.getCount()); // 0

        Counter c1 = new Counter();
        Counter c2 = new Counter();

        System.out.println("생성 후 카운트: " + Counter.getCount()); // 2

        Counter.reset();
        System.out.println("리셋 후 카운트: " + Counter.getCount()); // 0
    }
}
```
</details>
...
public class GameSettings {
    ...
    public static void printSettings() {
        ...
        System.out.println("타이틀: " + GAME_TITLE);
        System.out.println("해상도: " + SCREEN_WIDTH + "x" + SCREEN_HEIGHT);
        System.out.println("최대 FPS: " + MAX_FPS);
    }
}
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("isEmpty(\" hello \"): " + StringUtils.isEmpty(" hello ")); // false
        System.out.println("reverse(\"hello\"): " + StringUtils.reverse("hello")); // olleh
        System.out.println("countWords(\"Hello world Java\"): " + StringUtils.countWords("Hello world Java")); // 3
    }
}
```
</details>
