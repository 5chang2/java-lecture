...
public class Pencil {
    ...
    public void write(String message) {
        System.out.println(color + " 연필로 '" + message + "'를 씁니다.");
    }
}
```
...
public class Car {
    ...
    public void accelerate() {
        int acceleration = engine.getHorsePower() / 10;
        this.speed += acceleration;
        System.out.println("가속 (속도 +" + acceleration + ")");
    }

    public void showStatus() {
        System.out.println("[" + model + "] 마력: " + engine.getHorsePower() + ", 속도: " + speed + "km/h");
    }
}
```
</details>
...
public class Character {
    ...
    public void attack() {
        ...
        if (weapon != null) {
            weapon.attack();
            System.out.println(" (데미지: " + weapon.getDamage() + ")");
        } else {
            System.out.println("맨손 공격! (데미지: 5)");
        }
    }
...
public class CPU {
    ...
    public String getInfo() {
        return "CPU: " + model + " (" + clockSpeed + "GHz)";
    }
}
```
...
public class RAM {
    ...
    public RAM(String brand, int sizeGB) {
        this.brand = brand;
        this.sizeGB = sizeGB;
    }

    public String getInfo() {
        return "RAM: " + brand + " " + sizeGB + "GB";
    }
}
```
